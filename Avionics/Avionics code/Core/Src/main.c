...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : LORA_NSS_Pin LORA_RESET_Pin */
  GPIO_InitStruct.Pin = LORA_NSS_Pin|LORA_RESET_Pin;
  ...
  /*Configure GPIO pins : LORA_DIO3_Pin LORA_DIO2_Pin LORA_DIO1_Pin */
  GPIO_InitStruct.Pin = LORA_DIO3_Pin|LORA_DIO2_Pin|LORA_DIO1_Pin;
